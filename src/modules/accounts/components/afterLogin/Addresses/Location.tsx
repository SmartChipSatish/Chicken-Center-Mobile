...
const Location = ({ handleAddress }: { handleAddress: (data: any) => void }) => {
  ...
  const handleMapPress = async (e: any) => {
    ...
    console.log(latitude, longitude, 'saiiiiiiiiiiiii')
      ...
      try {
        ...
        if (granted === PermissionsAndroid.RESULTS.GRANTED) {
          ...
          Geolocation.getCurrentPosition(
            async (location: any) => {
              console.log(location.coords.latitude, location.coords.longitude, 'prakashhhhhhh')
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{ position: 'absolute', top: 20, left: 20 }}>
        ...
        {latitude && longitude ? (
          ...
          <Text style={{ color: 'red' }}>{error ? `Error: ${error}` : 'Fetching location...'}</Text>
        )}
